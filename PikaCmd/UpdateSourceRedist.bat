...
COPY /Y /B ..\src\PikaScript.h + ..\src\PikaScriptImpl.h + ..\src\QStrings.h + ..\src\QuickVars.h + ..\src\PikaScript.cpp + ..\src\QStrings.cpp + BuiltIns.cpp + PikaCmd.cpp SourceRedist\PikaCmdAmalgam.cpp >NUL
IF ERRORLEVEL 1 (
